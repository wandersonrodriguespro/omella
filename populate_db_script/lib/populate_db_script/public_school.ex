defmodule PopulateDBScript.PublicSchool do
  ...
  def changeset(public_school, attrs) do
    ...
    |> cast(attrs, [
      :school_name, 
      :state_name_public_school_latest_year,
      :state_abbr_public_school_latest_year, 
      :school_id_nces_assigned_public_school_latest_year, 
      :agency_name_public_school_2023_24, 
      :agency_id_nces_assigned_public_school_latest_year, 
      :ansi_fips_state_code_public_school_latest_year, 
    ...
    |> validate_required([:school_name, :state_name, :state_abbr])  # Defina os campos obrigatórios conforme necessário
  end
end
